// Compile with: clang -g insertion.c -o insertion
// Run with: ./insertion
// your implementation must use the provided swap function
...
// Input: The 'address of' two elements in an array that must be swapped.
